...
public class CommonPage extends BasePage {
	...
	public void switchiFrame(String string) {

		driver.get().switchTo().frame(string);
	}

	public String switchiFrame() {
		driver.get().switchTo().frame("ifmail");
		WebElement body = driver.get().findElement(By.cssSelector("body"));
		return body.getText();
	}
